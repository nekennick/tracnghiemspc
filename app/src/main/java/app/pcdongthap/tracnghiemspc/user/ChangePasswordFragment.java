        ...
        btnUpdatePassWord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (passwordNew.equals(passwordConfirm)) {
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(getActivity(), "Thành công", 0).show();
                                        progressDialog.dismiss();
                                    } else {
                                        Toast.makeText(getActivity(), "Thất bại", 0).show();
                                        progressDialog.dismiss();
                                        showDialog();
                                    }
                                }
                    ...
                    Toast.makeText(getActivity(), passwordConfirm + passwordNew, 0).show();
                    progressDialog.dismiss();
                }
            }
        });
    ...
    private void showDialog() {
        ...
        btnXacThuc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getActivity(), emailCurrent+passwordCurent, 0);
