package app.pcdongthap.tracnghiemspc.question;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_PATH = "/data/data/app.pcdongthap.tracnghiemspc/databases/";
    private static final String DB_NAME = "dbtracnghiem.sqlite";
